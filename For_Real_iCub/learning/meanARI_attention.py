...
fp = open(foldername + '/' + filename1 + str(sn).zfill(3) + "-" + str(en).zfill(3) + filename2 + '_avgARI_attention.csv', 'w')
...
for s in range(Data):
  ...
  for line in open(foldername +'/' + filename + '/' + trialname + '_'+ filename +'_ARI_attention.csv', 'r'):
