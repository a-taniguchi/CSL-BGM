...
sleep 2
#gnome-terminal --geometry=80x20+0+0 --command 'python ./learning/actionSeparate.py '$folder' '$bun' '$trial' '$action
python ./learning/actionSeparate.py $folder $bun $trial $action
