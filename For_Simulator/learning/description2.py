...
trialname = "testss" #raw_input("trialname?(folder) >")#"testss"#
start = "1"#raw_input("start number?>")
end   = param[1] #raw_input("end number?>")
sn = int(start)
en = int(end)
...
foldername = datafolder + trialname + "("+str(sn).zfill(3)+"-"+str(en).zfill(3)+")" #datafolder + 
print foldername
learningname_temp = param[2] #raw_input("learning trial name?>")
descriptionname = param[3] #raw_input("description trial name?>")#"001"#
num = int(param[4])
learningname = learningname_temp + str(num).zfill(3)
...
fp = open(filename + 'Word_description_probability_' + str(Data) + "_" + learningname +'.csv', 'w')
