...
print "world mk ssph 0.034 -0.16 0.58 0.35 0.1 1.5 0.1 " #right	green	box
print "world mk sbox 0.05 0.05 0.05 0.16 0.58 0.35 1.8 0.2 0.2 " #left	red	ball 
print "world mk scyl 0.03 0.04 0.0 0.58 0.30 0.1 0.1 1.5 " #front	blue	cup


print "world rot scyl 1 0 0 0  \n"
print "world rot scyl 1 90 0 0 \n"
...
left  = [ 0.16, 0.58, 0.35]
right = [-0.16, 0.58, 0.35]
front = [  0.0, 0.58, 0.30]
far   = [  0.0, 0.58, 0.45]

order = [left, right, front, far]

object_num = int(random.randint(2,3)) #Selection of the number of object on the table
